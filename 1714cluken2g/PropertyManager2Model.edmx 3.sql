...
-- --------------------------------------------------
-- Date Created: 10/23/2020 20:13:00
...
GO
IF OBJECT_ID(N'[dbo].[FK_PeopleApartment]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Apartments] DROP CONSTRAINT [FK_PeopleApartment];
GO
IF OBJECT_ID(N'[dbo].[FK_PeopleApartment1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Apartments] DROP CONSTRAINT [FK_PeopleApartment1];
GO
